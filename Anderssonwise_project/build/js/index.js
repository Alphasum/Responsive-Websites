...
templates['index'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<div>\n"
    ...
    + "\n<section>\n    <div class=\"flex flex-row justify-between m-auto\">\n        <img src=\"/build/img/Leonid_Furmansky_Camp_Shield_Andersson_Wise_Web_-60.avif\" alt=\"\" class=\"size-1/2\">\n        <div class=\"flex flex-col\">\n            <div class=\"m-60\">\n                <p class=\"mb-20\"> FEATURED PROJECT</p>\n                <p class=\"text-4xl mt-20\"> CAMPSITE AT SHIELD RANCH</p>\n                <p class=\"mt-20\">Campsite at Shield Ranch brings to fruition as sustainable 100% off-grid community designed to engage and celebrate the natural context of this 6800-acre hill country ecologically diverse sanctuary</p>\n                <button class=\"text-left w-full mt-40\"> VIEW THE PROJECT &#8594;</button>\n\n            </div>\n        </div>\n    </div>\n</section>\n\n"
  ...
  fn = lookupProperty(decorators,"inline")(fn,props,container,{"name":"inline","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"args":["pageContent"],"data":data,"loc":{"start":{"line":7,"column":0},"end":{"line":40,"column":11}}}) || fn;
  return fn;
  }
...
,"useDecorators":true,"4_d":  function(fn, props, container, depth0, data, blockParams, depths) {
  ...
  fn = lookupProperty(decorators,"inline")(fn,props,container,{"name":"inline","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.noop,"args":["pageContent"],"data":data,"loc":{"start":{"line":59,"column":0},"end":{"line":86,"column":11}}}) || fn;
  return fn;
  }
