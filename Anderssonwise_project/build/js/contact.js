...
templates['contact'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  fn = lookupProperty(decorators,"inline")(fn,props,container,{"name":"inline","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"args":["pageContent"],"data":data,"loc":{"start":{"line":6,"column":0},"end":{"line":89,"column":11}}}) || fn;
  return fn;
  }
